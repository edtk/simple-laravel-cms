        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box box-warning">
              ...
              <form role="form" method="POST" action="/questions/update/{{ $question[0]['id'] }}">
                @csrf
                <div class="box-body">        
                  <!-- text input -->
                  <div class="form-group">
                    <label>Title</label>
                    <input name="title" type="text" class="form-control" placeholder="Enter title" value="{{ $question[0]['title'] }}" required>
                  </div>
        
                  <!-- textarea -->
                  <div class="form-group">
                    <label>Description</label>
                    <textarea name="description" class="form-control" rows="3" placeholder="Enter description" value="{{ $question[0]['description'] }}" required>{{ $question[0]['description'] }}</textarea>
                  </div>
                </div>
