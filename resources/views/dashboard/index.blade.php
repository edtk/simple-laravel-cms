              ...
              <table class="table table-bordered">
                ...
                @foreach ($questions as $question)
                  <tr>
                    ...
                    <td>
                      <a href="/questions/edit/{{ $question->id }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i></a>
                      <a href="/questions/delete/{{ $question->id }}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                    </td>                
                  </tr>
                @endforeach
              </table>
